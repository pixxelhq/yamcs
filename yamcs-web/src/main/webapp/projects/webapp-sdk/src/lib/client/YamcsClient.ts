...
import {
  ...
  StreamEventIndexOptions,
  StreamPacketIndexOptions,
  StreamParameterIndexOptions,
  Value,
} from './types/monitoring';
import {
  CreateParameterListRequest,
  GetParameterListsResponse,
  ParameterList,
...
import {
  ...
  CompactRocksDbDatabaseRequest,
  CreateGroupRequest,
  CreateServiceAccountRequest,
  CreateServiceAccountResponse,
  CreateUserRequest,
  Database,
  EditClearanceRequest,
  EditGroupRequest,
  EditUserRequest,
  GeneralInfo,
...
export default class YamcsClient implements HttpHandler {
  ...
  createInstancesSubscription(
    observer: (instance: Instance) => void,
  ): InstancesSubscription {
  ...
  async getInstanceTemplate(name: string) {
    const response = await this.doFetch(
      `${this.apiUrl}/instance-templates/${name}`,
    );
  ...
  async getInstanceConfig(instance: string) {
    const response = await this.doFetch(
      `${this.apiUrl}/web/instance-config/${instance}`,
    );
  ...
  async createTimelineView(
    instance: string,
    options: CreateTimelineViewRequest,
  ) {
    const body = JSON.stringify(options);
    const url = `${this.apiUrl}/timeline/${instance}/views`;
    const response = await this.doFetch(url, {
  ...
  async updateTimelineView(
    instance: string,
    id: string,
    options: UpdateTimelineViewRequest,
  ) {
    const body = JSON.stringify(options);
    const url = `${this.apiUrl}/timeline/${instance}/views/${id}`;
    const response = await this.doFetch(url, {
  ...
  async createParameterList(
    instance: string,
    options: CreateParameterListRequest,
  ) {
    const body = JSON.stringify(options);
    const response = await this.doFetch(
      `${this.apiUrl}/parameter-lists/${instance}/lists`,
      {
        body,
        method: 'POST',
      },
  ...
  async updateParameterList(
    instance: string,
    id: string,
    options: UpdateParameterListRequest,
  ) {
    const body = JSON.stringify(options);
    const response = await this.doFetch(
      `${this.apiUrl}/parameter-lists/${instance}/lists/${id}`,
      {
        body,
        method: 'PATCH',
      },
  ...
  createSessionSubscription(
    observer: (sessionEvent: SessionEvent) => void,
  ): SessionSubscription {
    return this.webSocketClient!.createSubscription('session', {}, observer);
  }

  createTimeSubscription(
    options: SubscribeTimeRequest,
    observer: (time: Time) => void,
  ): TimeSubscription {
    return this.webSocketClient!.createSubscription('time', options, observer);
  }

  createReplicationInfoSubscription(
    observer: (info: ReplicationInfo) => void,
  ): ReplicationInfoSubscription {
  ...
  createSystemInfoSubscription(
    observer: (info: SystemInfo) => void,
  ): SystemInfoSubscription {
    return this.webSocketClient!.createSubscription('sysinfo', {}, observer);
  }

  createHttpTrafficSubscription(
    observer: (info: HttpTraffic) => void,
  ): HttpTrafficSubscription {
    return this.webSocketClient!.createSubscription(
      'http-traffic',
      {},
  ...
  createProcessorSubscription(
    options: SubscribeProcessorsRequest,
    observer: (processor: Processor) => void,
  ): ProcessorSubscription {
    return this.webSocketClient!.createSubscription(
      'processors',
      options,
  ...
  createBackfillingSubscription(
    options: SubscribeBackfillingRequest,
    observer: (data: SubscribeBackfillingData) => void,
  ): BackfillingSubscription {
    return this.webSocketClient!.createSubscription(
      'backfilling',
      options,
  ...
  createCop1Subscription(
    options: SubscribeCop1Request,
    observer: (cop1Status: Cop1Status) => void,
  ): Cop1Subscription {
    return this.webSocketClient!.createSubscription('cop1', options, observer);
  }

  createGlobalAlarmStatusSubscription(
    options: SubscribeGlobalAlarmStatusRequest,
    observer: (status: GlobalAlarmStatus) => void,
  ): GlobalAlarmStatusSubscription {
    return this.webSocketClient!.createSubscription(
      'global-alarm-status',
      options,
  ...
  createGlobalActivityStatusSubscription(
    options: SubscribeGlobalActivityStatusRequest,
    observer: (status: GlobalActivityStatus) => void,
  ): GlobalActivityStatusSubscription {
    return this.webSocketClient!.createSubscription(
  ...
  createTMStatisticsSubscription(
    options: SubscribeTMStatisticsRequest,
    observer: (time: Statistics) => void,
  ): TMStatisticsSubscription {
    return this.webSocketClient!.createSubscription(
      'tmstats',
      options,
  ...
  createAlgorithmStatusSubscription(
    options: SubscribeAlgorithmStatusRequest,
    observer: (status: AlgorithmStatus) => void,
  ): AlgorithmStatusSubscription {
    return this.webSocketClient!.createSubscription(
      'algorithm-status',
      options,
  ...
  createEventSubscription(
    options: SubscribeEventsRequest,
  ...
  createLinkSubscription(
    options: SubscribeLinksRequest,
    observer: (linkEvent: LinkEvent) => void,
  ): LinkSubscription {
    return this.webSocketClient!.createSubscription('links', options, observer);
  }

  createActivitySubscription(
    options: SubscribeActivitiesRequest,
    observer: (update: Activity) => void,
  ): ActivitySubscription {
    return this.webSocketClient!.createSubscription(
      'activities',
      options,
  ...
  createActivityLogSubscription(
    options: SubscribeActivityLogRequest,
    observer: (update: ActivityLog) => void,
  ): ActivityLogSubscription {
    return this.webSocketClient!.createSubscription(
      'activity-log',
      options,
  ...
  createTransferSubscription(
    options: SubscribeTransfersRequest,
    observer: (transfer: Transfer) => void,
  ): TransferSubscription {
    return this.webSocketClient!.createSubscription(
      'file-transfers',
      options,
  ...
  createRemoteFileListSubscription(
    options: SubscribeRemoteFileListRequest,
    observer: (fileList: ListFilesResponse) => void,
  ): RemoteFileListSubscription {
    return this.webSocketClient!.createSubscription(
      'remote-file-list',
      options,
  ...
  createParameterSubscription(
    options: SubscribeParametersRequest,
    observer: (data: SubscribeParametersData) => void,
  ): ParameterSubscription {
    // Allow dropped frames in case of high rate
    return this.webSocketClient!.createLowPrioritySubscription(
      'parameters',
      options,
      observer,
    );
  ...
  createParseFilterSubscription(
    options: ParseFilterRequest,
    observer: (data: ParseFilterData) => void,
  ): ParseFilterSubscription {
    return this.webSocketClient!.createSubscription(
      'web.parse-filter',
      options,
  ...
  createStreamStatisticsSubscription(
    options: SubscribeStreamStatisticsRequest,
  ...
  createStreamSubscription(
    options: SubscribeStreamRequest,
    observer: (data: StreamData) => void,
  ): StreamSubscription {
    // Allow dropped frames in case of high rate
    return this.webSocketClient!.createLowPrioritySubscription(
      'stream',
  ...
  createQueueStatisticsSubscription(
    options: SubscribeQueueStatisticsRequest,
    observer: (queue: CommandQueue) => void,
  ): QueueStatisticsSubscription {
    return this.webSocketClient!.createSubscription(
      'queue-stats',
      options,
  ...
  createQueueEventsSubscription(
    options: SubscribeQueueEventsRequest,
    observer: (event: CommandQueueEvent) => void,
  ): QueueEventsSubscription {
    return this.webSocketClient!.createSubscription(
      'queue-events',
      options,
  ...
  createAlarmSubscription(
    options: SubscribeAlarmsRequest,
    observer: (alarm: Alarm) => void,
  ): AlarmSubscription {
    return this.webSocketClient!.createSubscription(
      'alarms',
      options,
  ...
  createCommandSubscription(
    options: SubscribeCommandsRequest,
    observer: (entry: CommandHistoryEntry) => void,
  ): CommandSubscription {
    return this.webSocketClient!.createSubscription(
      'commands',
      options,
  ...
  async compactRocksDbDatabase(
    tablespace: string,
    dbPath = '',
    options: CompactRocksDbDatabaseRequest,
  ) {
    const body = JSON.stringify(options);
  ...
  async createEvent(instance: string, options: CreateEventRequest) {
    const body = JSON.stringify(options);
    const response = await this.doFetch(
      `${this.apiUrl}/archive/${instance}/events`,
      {
        body,
        method: 'POST',
      },
  ...
  async createQuery(
    instance: string,
    resource: string,
    options: CreateQueryRequest,
  ) {
    const body = JSON.stringify(options);
    const response = await this.doFetch(
      `${this.apiUrl}/web/queries/${instance}/${resource}`,
      {
        body,
        method: 'POST',
      },
  ...
  getCommandsDownloadURL(
    instance: string,
    options: DownloadCommandsOptions = {},
  ) {
    const url = `${this.apiUrl}/archive/${instance}:exportCommands`;
    return url + this.queryString(options);
  }

  async editReplayProcessor(
    instance: string,
    processor: string,
    options: EditReplayProcessorRequest,
  ) {
    const body = JSON.stringify(options);
  ...
  async runLinkAction(
    ...
    return this.doFetch(
      `${this.apiUrl}/links/${instance}/${link}/actions/${action}`,
      {
        method: 'POST',
  ...
  async resetLinkCounters(instance: string, link: string) {
    return this.doFetch(
      `${this.apiUrl}/links/${instance}/${link}:resetCounters`,
      {
        method: 'POST',
      },
    );
  ...
  async issueCommand(
    ...
    return this.issueCommandForNamespace(
      instance,
      processorName,
      null,
      qualifiedName,
  ...
  async issueCommandForNamespace(
    instance: string,
    processorName: string,
    ...
    const body = JSON.stringify(options);
    const response = await this.doFetch(
      `${this.apiUrl}/processors/${instance}/${processorName}/commands/${encodedName}`,
      {
        body,
        method: 'POST',
      },
  ...
  async startProcedure(
    instance: string,
    procedure: string,
    options?: StartProcedureOptions,
  ): Promise<ExecutorInfo> {
    const encodedName = encodeURIComponent(procedure);
    const body = JSON.stringify(options);
    const response = await this.doFetch(
      `${this.apiUrl}/spell/${instance}/procedures/${encodedName}:start`,
      {
        body,
        method: 'POST',
      },
  ...
  async streamPacketIndex(
    instance: string,
    options: StreamPacketIndexOptions,
  ...
  async streamParameterIndex(
    instance: string,
    options: StreamParameterIndexOptions,
  ): Promise<ArchiveRecord[]> {
  ...
  async streamCommandIndex(
    instance: string,
    options: StreamCommandIndexOptions,
  ): Promise<ArchiveRecord[]> {
  ...
  async streamEventIndex(
    instance: string,
    options: StreamEventIndexOptions,
  ): Promise<ArchiveRecord[]> {
  ...
  async getCompletenessIndex(
    instance: string,
    options: GetCompletenessIndexOptions,
  ): Promise<IndexGroup[]> {
  ...
  async streamCompletenessIndex(
    instance: string,
    options: StreamCompletenessIndexOptions,
  ): Promise<ArchiveRecord[]> {
  ...
  getPacketsDownloadURL(
    instance: string,
    options: DownloadPacketsOptions = {},
  ) {
  ...
  async getParameterTypes(
    instance: string,
    options: GetParameterTypesOptions = {},
  ) {
  ...
  getParameterValuesDownloadURL(
    instance: string,
    options: DownloadParameterValuesOptions = {},
  ) {
    const url = `${this.apiUrl}/archive/${instance}:exportParameterValues`;
    return url + this.queryString(options);
  }

  async exportParameterValues(
    instance: string,
    options: ExportParameterValuesOptions,
  ) {
    const url = `${this.apiUrl}/archive/${instance}:exportParameterValues`;
    const response = await this.doFetch(url, {
      method: 'POST',
  ...
  private encodeParameterName(parameter: string) {
    if (parameter.startsWith('/')) {
      ...
      if (idx !== -1) {
        ...
        // Not expected, let the server handle it
  ...
  async completeManualActivity(
    instance: string,
    activity: string,
    options: CompleteManualActivityOptions = {},
  ) {
  ...
  async runFileAction(
    instance: string,
    service: string,
    request: RunFileActionRequest,
  ) {
    return this.doFetch(
      `${this.apiUrl}/filetransfer/${instance}/${service}/files:runFileAction`,
      {
        method: 'POST',
  ...
  async doFetch(url: string, init?: RequestInit) {
    ...
    try {
      ...
      // NOTE: Fetch fails with "TypeError" on network or CORS failures.
