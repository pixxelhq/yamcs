...
public class SubServiceTwentySix implements PusSubService {
    ...
    private int diagnosticParameterReportStructureIDSize;

    private byte simpleCommutativeDifferentiator;
    private byte superCommutativeDifferentiator;

    SubServiceTwentySix(String yamcsInstance, YConfiguration config) {
        ...
        diagnosticParameterReportStructureIDSize = config.getInt("diagnosticParameterReportStructureIDSize", DEFAULT_HOUSEKEEPING_PARAMETER_REPORT_STRUCTURE_ID_SIZE);
