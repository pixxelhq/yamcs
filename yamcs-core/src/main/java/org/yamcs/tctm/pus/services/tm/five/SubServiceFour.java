...
public class SubServiceFour implements PusSubService {
    ...
    public ArrayList<TmPacket> process(TmPacket tmPacket) {
        ...
        if(eventMap == null) {
            log.error("Invalid APID, Event ID for S5,4 packet: {}, {}", apid, eventId);
        ...
        eventDec += " is thrown";
        eventProducer.sendEvent(EventSeverity.CRITICAL, PusTmManager.CcsdsApid.fromValue(apid).name(), eventDec, tmPacket.getGenerationTime());
