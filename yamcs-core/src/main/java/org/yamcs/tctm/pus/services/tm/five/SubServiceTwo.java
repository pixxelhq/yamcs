...
public class SubServiceTwo implements PusSubService {
    ...
    public ArrayList<TmPacket> process(TmPacket tmPacket) {
        ...
        if(eventMap == null) {
            log.error("Invalid APID, Event ID for S5,2 packet: {}, {}", apid, eventId);
        ...
        eventDec += " is thrown";
        eventProducer.sendEvent(EventSeverity.WARNING, CcsdsApid.fromValue(apid).name(), eventDec, tmPacket.getGenerationTime());
